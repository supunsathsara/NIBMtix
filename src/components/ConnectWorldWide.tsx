...
function ConnectWorldWide() {
  ...
  return (
    <div>
      ...
      <motion.h1 
          className="relative z-5 mb-2 text-lg md:text-5xl bg-clip-text text-transparent bg-gradient-to-b from-purple to-neutral-400 text-center font-sans font-bold"
        ...
        >
          With NIBMTix, sell tickets and manage events from anywhere in the world.  Unlock global access and streamline your event management seamlessly.
        </motion.p>
        <div className="w-full -bottom-20 h-72 md:h-3/4 z-10">
