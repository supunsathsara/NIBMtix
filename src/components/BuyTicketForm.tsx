...
const BuyTicketForm: React.FC<BuyTicketFormProps> = ({ eventData }) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <RadioGroup id="mealType" defaultValue="">
                  ...
                  <TooltipProvider>
                    <FormLabel>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            If you choose the cash option, please pay the amount
                            directly to an organizer.
                          </p>
                          <p>
